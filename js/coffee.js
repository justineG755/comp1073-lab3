...
class IcedCoffee extends Coffee {
    ...
    //constructor
    constructor(size, isDecaf, syrupFlavour, milkType) {
        //parent constructor
        super(size, isDecaf);
        ...
        //coffee type based on isDecaf boolean
        this.type = this.isDecaf ? "decaffeinated" : "caffeinated";
    }

    //description of the iced coffee
    icedCoffeeDesc() {
        return `A ${this.size} sized ${this.type} iced coffee with ${this.syrupFlavour} syrup and ${this.milkType} milk.`;
    }
}

//IcedCoffee objects
let coffee1 = new IcedCoffee("small", true, "vanilla", "oat");
let coffee2 = new IcedCoffee("medium", false, "caramel", "2%");

//display coffee cups
coffee1.serveIt();
coffee2.serveIt();

//description for the first coffee
let p1 = document.createElement("p");
p1.textContent = coffee1.icedCoffeeDesc();
output.appendChild(p1);

//description for the second coffee
let p2 = document.createElement("p");
p2.textContent = coffee2.icedCoffeeDesc();
